...
# remove it and than overwrite with new version. This simplifies iterative testing when mod code repository is not
# pleaced directly in Stellaris mod directory.
# 
